...
#define LOONGARCH_CSR_CRMD      0x0   /* Current Mode Information */
...
#define LOONGARCH_CSR_PRMD        0x1   /* Pre-exception Mode Information */
...
#define LOONGARCH_CSR_ECFG        0x4   /* Exception Configuration */
...
#define LOONGARCH_CSR_EENTRY      0xC   /* Exception Entry Point */
...
#define LOONGARCH_CSR_TLBEHI      0x11  /* TLB Entry High */
#define LOONGARCH_CSR_TLBELO0     0x12  /* TLB Entry Low 0 */
...
#define LOONGARCH_CSR_TLBELO1     0x13  /* TLB Entry Low 1 */
...
#define LOONGARCH_CSR_PGDL        0x19  /* Page Global Directory base Low */
#define LOONGARCH_CSR_PGDH        0x1A  /* Page Global Directory base High */
#define LOONGARCH_CSR_PGD         0x1B  /* Page Global Directory base */

#define LOONGARCH_CSR_PWCTL0      0x1C  /* Page Walk Control Low */
...
#define LOONGARCH_CSR_PWCTL1      0x1D  /* Page Walk Control High */
...
#define LOONGARCH_CSR_PRCFG2      0x22  /* Privileged Resource Config 2 */
#define  CSR_CONF2_PGMASK_SUPP		0x3ffff000

#define LOONGARCH_CSR_PRCFG3      0x23  /* Privileged Resource Config 3 */
...
#define LOONGARCH_CSR_KS0       0x30  /* Data Save Register 0 */
#define LOONGARCH_CSR_KS1       0x31  /* Data Save Register 1 */
#define LOONGARCH_CSR_KS2       0x32  /* Data Save Register 2 */
#define LOONGARCH_CSR_KS3       0x33  /* Data Save Register 3 */
#define LOONGARCH_CSR_KS4       0x34  /* Data Save Register 4 */
#define LOONGARCH_CSR_KS5       0x35  /* Data Save Register 5 */
#define LOONGARCH_CSR_KS6       0x36  /* Data Save Register 6 */
#define LOONGARCH_CSR_KS7       0x37  /* Data Save Register 7 */
#define LOONGARCH_CSR_KS8       0x38  /* Data Save Register 8 */
...
#define LOONGARCH_CSR_TCFG        0x41  /* Timer Configuration */
...
#define LOONGARCH_CSR_TVAL      0x42  /* Timer Value (Count) */
#define LOONGARCH_CSR_CNTC      0x43  /* Counter Compensation */
...
#define LOONGARCH_CSR_TLBRENTRY   0x88  /* TLB refill exceptino entry */
#define LOONGARCH_CSR_TLBRBADV    0x89  /* TLB refill badvaddr */
#define LOONGARCH_CSR_TLBRERA     0x8A  /* TLB refill exception return address */
#define LOONGARCH_CSR_TLBRSAVE    0x8B  /* TLB Refill Data Save */
#define LOONGARCH_CSR_TLBRELO0    0x8C  /* TLB refill entrylow0 */
#define LOONGARCH_CSR_TLBRELO1    0x8D  /* TLB refill entrylow1 */
...
#define LOONGARCH_CSR_MERRCTL     0x90  /* Machine Error control */
#define LOONGARCH_CSR_MERRINFO1   0x91  /* Machine Error information 1 */
#define LOONGARCH_CSR_MERRINFO2   0x92  /* Machine Error information 2 */
#define LOONGARCH_CSR_MERRENTRY   0x93  /* Machine Error exception entry */
#define LOONGARCH_CSR_MERRERA     0x94  /* Machine Error return address */
#define LOONGARCH_CSR_MERRSAVE    0x95  /* Machine Error data save */

/* Cache Tag Register */

#define LOONGARCH_CSR_CTAG        0x98  /* Cache TagLo + TagHi */
...
#define LOONGARCH_CSR_PERFCTRL0  0x201 /* 64 perf event 0 count value */
#define LOONGARCH_CSR_PERFCTRL1  0x202 /* 32 perf event 1 config */
#define LOONGARCH_CSR_PERFCTRL1  0x203 /* 64 perf event 1 count value */
#define LOONGARCH_CSR_PERFCTRL2  0x204 /* 32 perf event 2 config */
#define LOONGARCH_CSR_PERFCTRL2  0x205 /* 64 perf event 2 count value */
#define LOONGARCH_CSR_PERFCTRL3  0x206 /* 32 perf event 3 config */
#define LOONGARCH_CSR_PERFCTRL3  0x207 /* 64 perf event 3 count value */
...
#define LOONGARCH_CSR_FWPC      0x380 /* intruction breakpoint config */
#define LOONGARCH_CSR_FWPS      0x381 /* intruction breakpoint status */
